...
```json
{
  ...
  "serviceNamespace" : "tsm",
  "workloadNamespace" : "tsm"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","bsGitBranch":"","artifactVersion":"0.0.1-beta","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"tsm","projectName":"where-for-dinner","workloadNamespace":"tsm","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input14431648524701949627, --data-values-file, /tmp/accelerator-options2349791489828467448.json, --output-files, /tmp/ytt-output15435267965310493176]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","bsGitBranch":"","artifactVersion":"0.0.1-beta","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"tsm","projectName":"where-for-dinner","workloadNamespace":"tsm","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input17070824854719199324, --data-values-file, /tmp/accelerator-options1320533334077778815.json, --output-files, /tmp/ytt-output8946087352785096668]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","bsGitBranch":"","artifactVersion":"0.0.1-beta","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","enableSecurity":false,"numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"tsm","projectName":"where-for-dinner","workloadNamespace":"tsm","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input518366890044962249, --data-values-file, /tmp/accelerator-options14285886657601982848.json, --output-files, /tmp/ytt-output6133826563965599934]
